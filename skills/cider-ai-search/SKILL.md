...
description: Use when the user wants to find something on their Mac across reminders, Apple Notes, Safari history, or files in a selected folder, including a document or task they remember by subject rather than exact title.
---
